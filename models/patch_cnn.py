'''
PatchCNN - ECCV2020
    Chai, Lucy, et al. "What makes fake images detectable? understanding properties that generalize." Computer Vision–ECCV 2020: 16th European Conference, Glasgow, UK, August 23–28, 2020, Proceedings, Part XXVI 16. Springer International Publishing, 2020.
ref: https://github.com/chail/patch-forensics
'''
...
class CustomResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # x = torch.mean(x, dim=2)
        return dict(
            logits=x, # e.g. shape=torch.Size([32, 4, 128, 128])
        )
        # return x
